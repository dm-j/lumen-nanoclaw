...
9. [`routine` agent — reminders + calendar](roadmap/routine-agent.md) — built and wired 2026-09-16 (agent group, calendar mcp-shims, `ncl tasks` via `cli_scope: group`, description, destinations both directions with Dispatcher); a2a delegation confirmed working live
