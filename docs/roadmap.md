...
9. [`routine` agent — reminders + calendar](roadmap/routine-agent.md) — decided 2026-09-16 as the first non-Dispatcher specialist and first step toward eventually moving tools off Lumen onto her Crew entirely; tool surface (`ncl tasks` vs. existing vault task-capture shims) and shim ownership still need clarifying before build starts
